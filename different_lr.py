...
def show_different_learning_rate(dataset, results, plot_name):
    ...
    for result in results:
        ...
        axs[0].plot(
            np.arange(len(loss_history)), loss_history, label=f"LR: {learning_rate}"
        )
...
if __name__ == "__main__":
    ...
    # visualization
    show_different_learning_rate(
        args.dataset,
        results,
        f"different_lr/learning_curve_and_accuracy_curve_{args.dataset}_{args.model}_{args.activation}_{args.epochs}_{args.hidden_size}.png",
    )
