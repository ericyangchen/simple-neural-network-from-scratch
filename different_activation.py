...
def show_different_activation(dataset, results, plot_name):
...
if __name__ == "__main__":
    ...
    # visualization
    show_different_activation(
        args.dataset,
        results,
        f"different_activation/learning_curve_and_accuracy_curve_{args.dataset}_{args.model}_{args.activation}_{args.epochs}_{args.hidden_size}.png",
    )
