...
if __name__ == "__main__":
    ...
    if args.model == "FullyConnectedNeuralNetwork":
        ...
        model = ConvolutionalNeuralNetwork(
            ...
            hidden_channel=args.hidden_size,
            output_channel=1,
            kernel_size=3,
            stride=1,
            padding=1,
    ...
    show_learning_curve_and_accuracy_curve(
        loss_history,
        accuracy_history,
        f"{result_path}/learning_curve_and_accuracy_curve_{args.dataset}_{args.model}_{args.activation}_{args.epochs}_{args.learning_rate}_{args.hidden_size}.png",
    )
    show_result(
        x,
        y,
        y_pred_binary,
        f"{result_path}/result_{args.dataset}_{args.model}_{args.activation}_{args.epochs}_{args.learning_rate}_{args.hidden_size}.png",
    )
